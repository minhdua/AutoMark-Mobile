...
public class ImageDetectionProperties {
    ...
    public boolean checkOK(List<Point> pointsList){
        if ( isDetectedAreaBeyondLimits() || isDetectedHeightAboveLimit()
                || isDetectedWidthAboveLimit()
                || isEdgeTouching() || isAngleNotCorrect(pointsList) ) return false;
